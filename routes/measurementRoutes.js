...
const {createMeasurements,getMeasurementsById,getAllPersons,virtualTryOn} = require("../controllers/measurementsController")
...
router.post("/user/virtualTryon/",virtualTryOn)
